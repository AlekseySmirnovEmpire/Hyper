...
const Home = () => {
    ...
    return (
        <Container className="bg-dark bg-opacity-25" style={{}}>
            <h1 className="text-light text-center mb-4">Добро пожаловать!</h1>
            <Row className="justify-content-center">
                <Col className="align-content-center">
                    <p className="text-light text-center">Добро пожаловать на официальный сайт Диада! Чтобы быть в курсе последних событий:
                    подпишись на нас в соц. сетях:</p>
                    <Row className="justify-content-center">
                        <Col style={{
                            display: 'flex',
                            alignItems: 'center',
                            ...
                            <a style={{marginRight: 10}} target="_blank" href="https://t.me/diads_wave">
                            ...
                            <a target="_blank" href="https://vk.com/hyperdiad">
            ...
            <br/>
            <br/>
            <h2 className="text-light text-center mb-4">Новости</h2>
            <p className="text-light text-center mb-4">Новостей пока что нет!</p>
        </Container>
    );
};
